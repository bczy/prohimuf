...
await page.screenshot({ path: `${OUT}/probe-tear.png`, clip: { x: 430, y: 230, width: 300, height: 420 } });
await page.screenshot({ path: `${OUT}/probe-slit.png`, clip: { x: 640, y: 330, width: 320, height: 340 } });
