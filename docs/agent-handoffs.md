...
| [story-hostage-qte-duel](./handoffs/story-hostage-qte-duel.md)                         | open    | QTE rework, static-duel revision (ADR-0034 Rev. 2/0035); merged story-hostage-qte-rework.md in; PR #79's V1 retreat/porte-cochère build was playtest-REJECTED by Bertrand (D1) and reworked to a static captor + blown-peeks execution clock (§9 architect frozen delta, §10 design-gate PASS-WITH-CORRECTIONS, awaiting dev); F-1 now REVERSED (hostage killable again via the execution clock), superseding the earlier §5/§8 non-killable ruling/ratify-recommendation; C-1 field rename + ADR-0034 Revision 2 applied (`tech-writer`) |
