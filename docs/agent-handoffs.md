...
| [story-hostage-qte-duel](./handoffs/story-hostage-qte-duel.md)                         | pm-accepted | QTE rework "duel porte cochère" (ADR-0034/0035); merged story-hostage-qte-rework.md in; PR #79 pm ACCEPT-WITH-NOTES — F-1 (retire ADR-0030 hostage-death route) awaits Bertrand's one-line ratification, pm recommends RATIFY |
