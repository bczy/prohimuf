...
**Décision : `variantsPerStrip` = ~~6, plafond dur 6~~ → 10 (voir A19). `faceTemplates` = 1.** 40 assets de bande.
...
| `variantsPerStrip`                                       | ~~**6** — plafond dur 6~~ → **10** (A19, 2026-08-09)                                                                                                                                                                                                                                                                                                                                                                                                                                                         | A5                                                                    |
...
- §3/§4.1 : `variantsPerStrip` **6** → **10** (A19), composition de leurres V1 (A5), généralisée à `variantCount - 3`.
