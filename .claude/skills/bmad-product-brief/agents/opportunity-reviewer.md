...
- **What's the bigger story?** If you zoom out,
 is there a more compelling narrative?
...
Return ONLY the following JSON object. No preamble,
 no commentary. Focus on the 2-3 most impactful opportunities per section,
...
```json
{
 ...
 "impact": "how it strengthens the brief" }
  ...
  "growth_and_scale": ["bullet — network effects,
 viral loops,
 expansion paths"],

  "strategic_partnerships": [{ "partner_type": "who",
 "value": "why this alliance matters" }],

  "underemphasized_strengths": [
    { "strength": "what's underplayed",
 "suggestion": "how to elevate it" }
  ]
}
```
