...
- User journeys,
 success criteria,
 and domain requirements are documented
- Focus on strategic scope decisions,
 not feature details
...
- Present synthesis of established vision,
 success criteria,
 journeys
- Assess domain and innovation focus
- Evaluate scope implications: simple MVP,
 medium,
 or complex project
...
- Explore MVP philosophy options: problem-solving,
 experience,
 platform,
 or revenue MVP
...
- For each journey and success criterion,
 ask:
  - Without this,
...
- Ask what features could be added in versions 2,
 3,
 etc.
...
Present the scoping decisions for review,
 then display menu:
...
- IF A: Invoke the `bmad-advanced-elicitation` skill with the current scoping analysis,
...
- IF P: Invoke the `bmad-party-mode` skill with the scoping context,
 process the collaborative insights on MVP and roadmap decisions,
...
- IF C: Append the final content to {outputFile},
 ...
 then read fully and follow: ./step-09-functional.md
