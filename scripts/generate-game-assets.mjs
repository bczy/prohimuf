#!/usr/bin/env node
/** * Game asset generator — Prohibition remake * Generates specific game assets for public/assets/ * Uses Pollinations.ai (free, no API key required) * * Usage: *   node scripts/generate-game-assets.mjs *   node scripts/generate-game-assets.mjs --asset facade_bg */
...
const ASSETS = [
...

  {
    ...
    prompt:
      "Classic Haussmann Parisian building facade at night, stone columns, ornate balconies, varied windows lit and dark, 90s Paris, photocopied fanzine style, high contrast black white neon accents, flat 2D game background",
...

  {
    ...
    prompt:
      "90s Paris banlieue HLM social housing tower facade at night, graffiti tags, broken windows, satellite dishes, fanzine photocopy style, high contrast black white cyan neon accents, flat 2D game background",
...

  {
    ...
    prompt:
      "Abandoned Paris warehouse squat facade at night, large industrial windows, rust, rave posters pasted on walls, makeshift rave venue, fanzine photocopied style, high contrast black white orange neon, flat 2D game background",
...

  {
    ...
    prompt:
      "Paris mixed-use building facade at night, ground floor bars and shops with neon signs, shuttered storefronts, upper floors residential, 90s street scene, fanzine style, high contrast black white neon, flat 2D game background",
...

  {
    ...
    prompt:
      "Paris 90s RG intelligence agent, suit and tie, binoculars lowered, standing watching from window, fanzine photocopy style, high contrast black white, neon purple glow outline, flat sprite, game character, transparent bg",
...

  {
    ...
    prompt:
      "Paris 90s CRS riot police officer, full riot gear, helmet visor up, baton at side, standing in window, fanzine photocopy style, high contrast black white, neon orange glow outline, flat sprite, transparent bg",
  ...
  // ── Enemy sprites — alert ────────────────────────────────────────────────────
  {
    ...
    description: "Enemy — spotted player, alert pose",

    prompt:
      "Paris 90s cop in window, alert pose, pointing finger, leaning forward, just spotted something, fanzine photocopy style, high contrast black white, bright white flash glow, flat sprite, transparent bg",
...

  {
    ...
    prompt:
      "Paris 90s undercover cop in window, radio to mouth, calling backup, urgent expression, fanzine photocopy style, high contrast black white, static electricity yellow glow, flat sprite, transparent bg",
...

  {
    ...
    prompt:
      "Paris 90s RG intelligence agent firing from window, silenced pistol, calm expression, fanzine photocopy style, high contrast black white, purple neon muzzle flash, flat sprite, transparent bg",
  ...
  // ── Player in-game ───────────────────────────────────────────────────────────
  {
    ...
    prompt:
      "Small 2D courier character sprite, hoodie and backpack, standing idle, bottom-up view, fanzine photocopy style, high contrast black white, green neon glow, flat sprite, transparent background",
...

  {
    ...
    prompt:
      "Small 2D courier character sprite, hoodie and backpack, mid-walk pose, fanzine photocopy style, high contrast black white, green neon outline, flat sprite, transparent background",
...

  {
    ...
    prompt:
      "Targeting crosshair circle, red neon color, locked-on enemy indicator, fanzine screen print style, flat 2D, transparent background, game UI",
...

  {
    ...
    prompt:
      "Red neon bullet tracer, fanzine style, glowing red dot with trail, transparent background, enemy game sprite",
...

  {
    ...
    prompt:
      "Small explosion burst effect sprite, fanzine photocopy style, white flash with orange neon streaks, flat 2D, transparent background, game visual effect",
...

  {
    ...
    prompt:
      "Impact hit spark effect sprite, star burst flash, white and yellow neon, fanzine style, flat 2D, transparent background, game hit effect",
...

  {
    ...
    prompt:
      "Small smoke cloud puff sprite, grey and black, fanzine photocopy grainy style, flat 2D, transparent background, game effect",
  ...
  // ── HUD elements ─────────────────────────────────────────────────────────────
  {
    ...
    prompt:
      "Heart life icon, fanzine hand-drawn style, thick outline, neon red fill, flat 2D, transparent background, game HUD element",
...

  {
    ...
    prompt:
      "Skull icon, fanzine punk style, thick outline, white on black, flat 2D, transparent background, game HUD death indicator",
...

  {
    ...
    prompt:
      "Police siren light icon, fanzine photocopy style, alternating red and blue neon, flat 2D, transparent background, game HUD alarm indicator",
...

  {
    ...
    prompt:
      "Vinyl record icon, fanzine hand-drawn style, thick outline, flat 2D, transparent background, game HUD collectible indicator",
