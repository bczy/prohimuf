  ...
  return (
    <div
      ...
      style={{
        position: "fixed",
        inset: 0,
        background: `radial-gradient(ellipse at center, rgba(8,6,20,0.6) 0%, rgba(8,6,20,0.92) 100%), url('${import.meta.env.BASE_URL}assets/levels/belliard/facade.png') center/cover no-repeat`,
