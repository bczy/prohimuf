/**
 * Pure gesture CLASSIFICATION for the portrait-robot bands (ADR-0083 D2/D2bis). The
 ...
 * decision (ADR-0083 D3). The values here are **provisional defaults** that make the
...
/** Normalised travel per cran of a desktop drag (ADR-0083 D2bis, B3). */
...
/**
 * Fold one pointer-move delta into a carried remainder (ADR-0083 D2bis). A swipe is
