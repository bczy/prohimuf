 ...
 * ADR-0080, ADR-0081; tuning canon: `docs/game-design/design-gate-portrait-robot.md` §3).
 *
 ...
 * (ADR-0081 D1). No `SWIPE`, no `DRAG`, no `TAP`, no `ARROW_LEFT`: if a
 ...
 * reducer (ADR-0081 D1). The resolution kept a name — the rule
...
export interface PortraitScene {
   ...
   * render layer (ADR-0081 D4, same breach as ADR-0079 A5 at a smaller scale).
   */
